...
class LSTMWithEmbeddingModelForClassificationTest(unittest.TestCase):
    ...
    def test(self):
        ...
        for iter in range(epochs):
            ...
            for i in range(dataTrain.shape[0]):
                ...
                lstm_input_sentence = Tensor(lstm_input_words.data.sum(1)/lstm_input_words.data.shape[2], autograd=True)
